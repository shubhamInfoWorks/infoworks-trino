...
{
    private io.trino.plugin.databricks.TestingMySqlServer mySqlServer;
    ...
    public void createQueryRunner()
            throws Exception
    {
        mySqlServer = new io.trino.plugin.databricks.TestingMySqlServer();
        try {
    ...
    private static Session getSession(io.trino.plugin.databricks.TestingMySqlServer mySqlServer)
    {
