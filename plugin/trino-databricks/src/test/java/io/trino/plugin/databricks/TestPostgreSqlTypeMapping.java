...
import static io.trino.plugin.databricks.DatabricksConfig.ArrayMapping.AS_JSON;
import static io.trino.plugin.databricks.DatabricksConfig.ArrayMapping.DISABLED;
        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testArrayDisabled()
    {
        Session session = Session.builder(getSession())
                .setCatalogSessionProperty("postgresql", DatabricksSessionProperties.ARRAY_MAPPING, DISABLED.name())
                .build();
