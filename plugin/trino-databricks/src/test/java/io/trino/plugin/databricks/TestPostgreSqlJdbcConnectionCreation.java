...
import static io.trino.plugin.databricks.PostgreSqlQueryRunner.createSession;
            ...
            throws Exception
    {
        ...
        try {
            ...
            queryRunner.installPlugin(new JdbcPlugin(
                    "postgresql",
                    combine(new DatabricksClientModule(), new TestingPostgreSqlModule(connectionCountingConnectionFactory))));
