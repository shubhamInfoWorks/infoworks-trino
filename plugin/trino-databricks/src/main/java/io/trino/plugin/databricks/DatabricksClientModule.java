        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        configBinder(binder).bindConfig(DatabricksJdbcConfig.class);
    ...
    @Singleton
    @ForBaseJdbc
    public static ConnectionFactory createConnectionFactory(BaseJdbcConfig config, CredentialProvider credentialProvider, DatabricksConfig mySqlConfig)
            throws SQLException
    {
    ...
    public static Properties getConnectionProperties(DatabricksConfig mySqlConfig)
    {
