...
import io.trino.plugin.databricks.DatabricksConfig.ArrayMapping;
...
public final class DatabricksSessionProperties
        implements SessionPropertiesProvider
{
    ...
    @Inject
    public DatabricksSessionProperties(DatabricksConfig databricksConfig)
    {
