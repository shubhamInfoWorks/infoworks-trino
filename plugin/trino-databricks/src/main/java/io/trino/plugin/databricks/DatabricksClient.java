...
import static io.trino.plugin.databricks.DatabricksConfig.ArrayMapping.AS_ARRAY;
import static io.trino.plugin.databricks.DatabricksSessionProperties.getArrayMapping;
import static io.trino.plugin.databricks.DatabricksSessionProperties.isEnableStringPushdownWithCollate;
import static io.trino.plugin.databricks.TypeUtils.arrayDepth;
import static io.trino.plugin.databricks.TypeUtils.getArrayElementPgTypeName;
import static io.trino.plugin.databricks.TypeUtils.getJdbcObjectArray;
...
{
    private static final Logger log = Logger.get(DatabricksClient.class);
            ...
            RemoteQueryModifier queryModifier)
    {
        ...
        this.disableAutomaticFetchSize = true;
        ...
        if (databricksConfig.isIncludeSystemTables()) {
        ...
        this.aggregateFunctionRewriter = new AggregateFunctionRewriter<>(
                ...
                ImmutableSet.<AggregateFunctionRule<JdbcExpression, ParameterizedExpression>>builder()
                        ...
                        .add(new ImplementSum(DatabricksClient::toTypeHandle))
